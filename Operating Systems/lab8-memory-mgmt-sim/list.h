...
/* Add in ascending order by start address */
void list_add_ascending_by_address(list_t *l, block_t *blk);

/* Add in ascending order by block size */
void list_add_ascending_by_blocksize(list_t *l, block_t *blk);

/* Add in descending order by block size */
...
/* Returns the index at which the given block appears. */
